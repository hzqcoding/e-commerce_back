<template>
  <div>
    ...
    <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogClosed">
      <el-form :model="userInfo" ref="userInfoRef" label-width="120px">
        <el-form-item label="当前用户姓名：" prop="username">
          <el-input v-model="userInfo.username" disabled></el-input>
        </el-form-item>
        <el-form-item label="当前角色名称：">{{userInfo.role_name}}</el-form-item>
